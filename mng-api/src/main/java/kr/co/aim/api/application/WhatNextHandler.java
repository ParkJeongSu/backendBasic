...
public class WhatNextHandler implements MessageHandler<String> {
    ...
    public Object handle(String message) {
        // 1. 자신에게 맞는 DTO로 역직렬화
        TypeReference<BaseMessage<WhatNextBody>> typeRef = new TypeReference<>() {};
        BaseMessage<WhatNextBody> request = objectMapper.readValue(message, typeRef);
